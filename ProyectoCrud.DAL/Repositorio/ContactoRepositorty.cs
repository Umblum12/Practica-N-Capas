...
{
    public class ContactoRepositorty : IGenericRepository<Contacto>
    {
        private readonly DbcrudcoreContext _dbContext;
        public ContactoRepositorty(DbcrudcoreContext Context)
        {
            _dbContext = Context;
        }
        ...
        public async Task<bool> Inertar(Contacto modelo)
        {
